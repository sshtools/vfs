...
public abstract class AFPCNode extends Utility implements AFPConstants, Iterable<AFPCNode>
{
	...
	public abstract boolean moveTo(AFPCNode dir, String newName)
		;
	...
	public abstract AFPFork openFileFork(int flags)
		;

	public abstract AFPFork openResourceFork(int flags)
		;
	...
	public abstract AFPCNode createFile(String name)
		;

	public abstract AFPCNode createDirectory(String name)
		;

	public abstract AFPCNode getChild(String name)
		;
